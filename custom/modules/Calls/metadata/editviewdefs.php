...
array (
  ...
  array (
    ...
    array (
        ...
        array (
          ...
          array (
            'customCode' => '{if $fields.status.value != "Held"}<input title="{$APP.LBL_CLOSE_AND_CREATE_BUTTON_TITLE}" accessKey="{$APP.LBL_CLOSE_AND_CREATE_BUTTON_KEY}" class="button" onclick="fill_invitees(); this.form.status.value=\'Held\'; this.form.action.value=\'Save\'; this.form.return_module.value=\'Calls\'; this.form.isDuplicate.value=true; this.form.isSaveAndNew.value=true; this.form.return_action.value=\'EditView\'; this.form.return_id.value=\'{$fields.id.value}\'; return check_form(\'EditView\') && isValidDuration();" type="submit" name="button" value="{$APP.LBL_CLOSE_AND_CREATE_BUTTON_LABEL}">{/if}',
              ...
              4 =>
          array (
            'customCode' => '{if $fields.status.value != "Held"}<input  class="button" onclick="fill_invitees(); this.form.action.value=\'Save\'; this.form.return_module.value=\'Tasks\';  this.form.isSaveAndNew.value=true; this.form.return_action.value=\'EditView\'; this.form.return_id.value=\'{$fields.id.value}\'; return check_form(\'EditView\') && isValidDuration();" type="submit" name="button" value="Save and Create a Task">{/if}',
          ),
            5 =>
          array (
            'customCode' => '{if $fields.status.value != "Held"}<input class="button" onclick="fill_invitees(); this.form.action.value=\'Save\'; this.form.return_module.value=\'Opportunities\'; this.form.isSaveAndNew.value=true;  this.form.return_action.value=\'EditView\'; this.form.return_id.value=\'{$fields.id.value}\'; return check_form(\'EditView\') && isValidDuration();" type="submit" name="button" value="Save and Create an Opportunity">{/if}',
          ),
        ),
      ...
      'javascript' => '<script type="text/javascript" src="include/JSON.js?s=0ae3b4a29ce69d9a71e70b194a67eaba&c=1"></script>
<script type="text/javascript" src="include/jsolait/init.js?s=0ae3b4a29ce69d9a71e70b194a67eaba&c=1"></script>
<script type="text/javascript" src="include/jsolait/lib/urllib.js?s=0ae3b4a29ce69d9a71e70b194a67eaba&c=1"></script>
<script type="text/javascript">{$JSON_CONFIG_JAVASCRIPT}</script>
<script type="text/javascript" src="include/javascript/jsclass_base.js?s=0ae3b4a29ce69d9a71e70b194a67eaba&c=1"></script>
<script type="text/javascript" src="include/javascript/jsclass_async.js?s=0ae3b4a29ce69d9a71e70b194a67eaba&c=1"></script>
<script type="text/javascript" src="modules/Meetings/jsclass_scheduler.js?s=0ae3b4a29ce69d9a71e70b194a67eaba&c=1"></script>
