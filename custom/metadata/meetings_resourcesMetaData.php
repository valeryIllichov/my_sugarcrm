...
*****************************************************************************/
$dictionary['meetings_resources'] = array (
	...
	'indices' => array (
		array(	'name'			=>'meetings_resspk',
				'type'			=>'primary',
				'fields'		=>array('id'),
		),
		array(	'name'			=>'idx_mtg_res_mtg',
				'type'			=>'index',
				'fields'		=>array('meeting_id'),
		),
		array(	'name'			=>'idx_mtg_res_res',
				'type'			=>'index',
				'fields'		=>array('resource_id'),
		),
		array(	'name'			=>'idx_meeting_resources',
				'type'			=>'alternate_key',
				'fields'=>array('meeting_id','resource_id'),
		),
	),
	'relationships' => array(
		'meetings_resources' => array(
			'lhs_module'		=> 'Meetings',
			'lhs_table'			=> 'meetings',
			'lhs_key'			=> 'id',
