...
strlen($_GET['specialtype']) > 0 ? $specialtype=$_GET['specialtype'] : $specialtype=null;
strlen($_GET['account']) > 0 ? $account=explode(';',$_GET['account']) : $account=null;
/* function getCustomerSales($startIndex, $maxRecords, $sort, $sort_dir, $location, $region, $slsm, $dealerType, $specialType) */
$returnArray=FMPSales::getCustomerSales($startIndex, $results, $sort, $sort_dir, $selectMethod, $location, $region, $slsm, $dealertype, $specialtype,$account,false,array());
