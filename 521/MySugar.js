...
SUGAR.mySugar = function() {
    ...
    return {
        ...
        configureDashlet: function(id) {
            ...
            var cObj = YAHOO.util.Connect.asyncRequest('GET','521_config.php?tab='+id, 
            {
        ...
        save521config: function(formdata) {
//            console.log(formdata);
            ...
            var cObj = YAHOO.util.Connect.asyncRequest('POST', '521_config.php', callback);
//            console.log(cObj);
            return false;
        },
        ...
        renderDashletsDialog: function(){	
            SUGAR.mySugar.dashletsDialog = new YAHOO.widget.Dialog("dashletsDialog", 
            {
                ...
                visible : false, 
                effect:[{
                    effect:YAHOO.widget.ContainerEffect.SLIDETOP, 
                    duration:0.5
                },{
                    effect:YAHOO.widget.ContainerEffect.FADE,
                    duration:0.5
