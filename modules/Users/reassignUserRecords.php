...
echo "<h4>{$mod_strings_users['LBL_REASS_SCRIPT_TITLE']}</h4>";
...
?>
<table border='0' cellspacing='0' cellpadding='0'  class='tabDetailView'>
<tr>
<td class='tabDetailViewDF'>
<?php echo $mod_strings_users['LBL_REASS_DESC_PART1']; ?><BR><BR>
<?php echo $mod_strings_users['LBL_REASS_SELECT_USER']; ?>
<form method=post action="index.php?module=Users&action=reassignUserRecords">
<BR>
...
foreach($moduleFilters as $modFilter => $fieldArray){
	...
	echo "<h5>{$app_list_strings['moduleList'][$modFilter]} ", " {$mod_strings_users['LBL_REASS_FILTERS']}</h5>\n";
