...
class DSls_DailySalesDashlet extends DashletGeneric {
    function DSls_DailySalesDashlet($id, $def = null) {
        global $current_user, $app_strings;
        require('modules/DSls_DailySales/metadata/dashletviewdefs.php');

        parent::DashletGeneric($id, $def);

        if(empty($def['title'])) $this->title = translate('LBL_HOMEPAGE_TITLE', 'DSls_DailySales');
...
//
//        return $this->getTitle('') . '<div align="center"> QWEQWE '. $current_user->name. '</div><br />';
//    }
}
