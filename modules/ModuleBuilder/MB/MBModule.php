...
class MBModule
{
    ...
    var $errors = array ( ) ;
    var $path = '' ;
    var $implementable = array (



    'has_tab' => 'Navigation Tab' ) ;
    var $always_implement = array ( 'assignable' => 'Assignable' , 'acl' => 'Access Controls' , 'studio' => 'Studio Support' , 'audit' => 'Audit Table' ) ;
    var $iTemplate = array (
    ...
    function MBModule ($name , $path , $package , $package_key)
    {
        ...
        'has_tab' => $GLOBALS [ 'mod_strings' ] [ 'LBL_NAV_TAB' ] ) ;
    ...
    function getNodes ()
    {
        ...
        $layouts = array (
        			 array ( 'name' => translate('LBL_EDITVIEW') , 'type' => 'edit' , 'action' => 'module=ModuleBuilder&MB=true&action=editLayout&view=editView&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        			 array ( 'name' => translate('LBL_DETAILVIEW') , 'type' => 'detail' , 'action' => 'module=ModuleBuilder&MB=true&action=editLayout&view=detailView&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        			 array ( 'name' => translate('LBL_LISTVIEW') , 'type' => 'list' , 'action' => 'module=ModuleBuilder&MB=true&action=editLayout&view=ListView&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        			 array ( 'name' => translate('LBL_DASHLET') , 'type' => 'Folder', 'children' => $dashlets, 'action' => 'module=ModuleBuilder&MB=true&action=wizard&dashlet=1&view_module=' . $this->name . '&view_package=' . $this->package  ),
        			 array ( 'name' => translate('LBL_SEARCH_FORMS') , 'action' => 'module=ModuleBuilder&MB=true&action=wizard&search=1&view_module=' . $this->name . '&view_package=' . $this->package , 'type' => 'folder' , 'children' => $searchSubs ) ) ;
    ...
    function removeFieldFromLayouts ( $fieldName )
    {
        ...
        foreach ( array ( 'editview' , 'detailview' , 'listview' , 'basic_search' , 'advanced_search' , 'dashlet' ) as $type )
        {
