	...
	{foreach from=$available_fields item='col' key='id'}
		<div class='le_field' id='{$idCount}'>
			{if ! $fromModuleBuilder && ($col.name != '(filler)')}
				<img class='le_edit' src="themes/Sugar/images/edit_inline.gif" style='float:right; cursor:pointer;' onclick="var value_label = document.getElementById('le_label_{$idCount}').innerHTML; var value_tabindex = document.getElementById('le_tabindex_{$idCount}').innerHTML;ModuleBuilder.getContent('module=ModuleBuilder&action=editProperty&view_module={$view_module}&view={$view}&id_label=le_label_{$idCount}&name_label=label_{$col.label}&title_label={sugar_translate label='LBL_LABEL_TITLE' module='ModuleBuilder'}&value_label=' + value_label + '&id_tabindex=le_tabindex_{$idCount}&title_tabindex={sugar_translate label='LBL_TAB_ORDER' module='ModuleBuilder'}&name_tabindex=tabindex&value_tabindex=' + value_tabindex );" />
			{/if}
...
{foreach from=$layout item='panel' key='panelid'}
	...
	<div class='le_panel' id='{$idCount}'>
        ...
        <img class='le_edit' src="themes/Sugar/images/edit_inline.gif" style='float:right; cursor:pointer;' onclick="var value_label = document.getElementById('le_panelname_{$idCount}').innerHTML;ModuleBuilder.getContent('module=ModuleBuilder&action=editProperty&view_module={$view_module}{if $fromModuleBuilder}&view_package={$view_package}{/if}&view={$view}&id_label=le_panelname_{$idCount}&name_label=label_{$panelid|upper}&title_label={sugar_translate label='LBL_LABEL_TITLE' module='ModuleBuilder'}&value_label=' + value_label );" />
        {/if}
		{counter name='idCount' assign='idCount' print=false}
		...
		{foreach from=$panel item='row' key='rid'}
			...
			{foreach from=$row item='col' key='cid'}
				<div class='le_field' id='{$idCount}'>
			        {if ! $fromModuleBuilder && ($col.name != '(filler)')}
						<img class='le_edit' src="themes/Sugar/images/edit_inline.gif" style='float:right; cursor:pointer;' onclick="var value_label = document.getElementById('le_label_{$idCount}').innerHTML; var value_tabindex = document.getElementById('le_tabindex_{$idCount}').innerHTML;ModuleBuilder.getContent('module=ModuleBuilder&action=editProperty&view_module={$view_module}{if $fromModuleBuilder}&view_package={$view_package}{/if}&view={$view}&id_label=le_label_{$idCount}&name_label=label_{$col.label}&title_label={sugar_translate label='LBL_LABEL_TITLE' module='ModuleBuilder'}&value_label=' + value_label + '&id_tabindex=le_tabindex_{$idCount}&title_tabindex={sugar_translate label='LBL_TAB_ORDER' module='ModuleBuilder'}&name_tabindex=tabindex&value_tabindex=' + value_tabindex );" />
					{/if}
