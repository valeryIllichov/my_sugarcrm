...
$dashletData['MyAccountsDashlet']['columns'] =  array('custno_c' => array('width' => '8',
                                                                          'label' => 'LBL_CUSTNO',
                                                                          'default' => true),
                                                      'name' => array('width'   => '40', 
                                                      ...
                                                      'mtd_sales_c' => array('width' => '8',
                                                                             'label' => 'LBL_MTD_SALES',
                                                                             'currency_format' => 'true',
                                                                              'default' => true),
                                                      'mtd_gp_c' => array('width' => '8',
                                                                             'label' => 'LBL_MTD_GP',
                                                                             'currency_format' => 'true'),
                                                      'ytd_sales_c' => array('width' => '8',
                                                                             'label' => 'LBL_YTD_SALES',
                                                                             'currency_format' => 'true'),
                                                      'ytd_gp_c' => array('width' => '8',
                                                                             'label' => 'LBL_YTD_GP',
                                                                             'currency_format' => 'true'),
                                                      'mtd_budget_sales_c' => array('width' => '8',
                                                                             'label' => 'LBL_MTD_BUDGET_SALES',
                                                                             'currency_format' => 'true',
                                                                              'default' => true),
                                                      'ytd_budget_sales_c' => array('width' => '8',
                                                                             'label' => 'LBL_YTD_BUDGET_SALES',
                                                                             'currency_format' => 'true'),
                                                      'mtd_projected_c' => array('width' => '8',
                                                                             'label' => 'LBL_MTD_PROJECTED',
                                                                             'currency_format' => 'true',
                                                                              'default' => true),
                                                      'ytd_projected_c' => array('width' => '8',
