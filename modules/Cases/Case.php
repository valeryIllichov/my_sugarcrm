...
//		$this->assigned_user_name = get_assigned_user_name($this->assigned_user_id);
	...
	*/
	...
	function get_list_view_data(){
		...
		$temp_array['CONNECTION_C'] = (($this->connection_c == "") ? "" : $this->connection_c);
	...
	*/
	...
	{
		global $app_list_strings;
                $query = "SELECT acc.custno_c custno from accounts  acc where acc.id = '" . $case->account_id . "'";
		$result = $this->db->query($query,true," Error filling in additional detail fields: ");
		$row = $this->db->fetchByAssoc($result);
                $xtpl->assign("CASE_SUBJECT", $case->connection_c);
                $xtpl->assign("CASE_CUSTOMER", $case->account_name." (".$row['custno'].")");
                $xtpl->assign("CASE_REQUEST_DATE", $case->request_date_c);
		...
		$xtpl->assign("CASE_STATUS", (isset($case->status) ? $app_list_strings['case_status_dom'][$case->status]:""));
                $xtpl->assign("CASE_PSC", $case->connection_type_c == 'no' ? 'No' : 'Yes');
                $xtpl->assign("CASE_SMS", $case->subject_c == 'no' ? 'No' : 'Yes'.' ('.$case->subject_c.')');
                $xtpl->assign("CASE_CATALOG", $case->connection_timing_c);
                $xtpl->assign("CASE_DESCRIPTION", $case->description);
                $xtpl->assign("CASE_RESOLUTION", $case->resolution);
                return $xtpl;
	}
