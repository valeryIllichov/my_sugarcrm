...
if(isset($_POST['handle']) && $_POST['handle'] == 'Save'){
  ...
  echo $sugar_smarty->fetch('modules/Leads/ConvertLead.tpl');
    ...
    $selectAccountButton = "<script language=\"javascript\">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['display_account_name']={\"method\":\"query\",\"modules\":[\"Accounts\"],\"group\":\"or\",\"field_list\":[\"name\",\"custno_c\",\"id\",\"shipping_address_street\",\"shipping_address_city\",\"shipping_address_state\",\"shipping_address_postalcode\",\"custno_c\"],\"populate_list\":[\"display_account_name\", \"account_name_custno\", \"selectedAccount\"],\"required_list\":[\"selectedAccount\"],\"conditions\":[{\"name\":\"name\",\"op\":\"like_custom\",\"end\":\"%\",\"value\":\"\"}],\"order\":\"name\",\"limit\":\"30\",\"no_match_text\":\"No Match\"}; sqs_objects['account_name_custno']={\"method\":\"query\",\"modules\":[\"Accounts\"],\"group\":\"or\",\"field_list\":[\"custno_c\",\"name\",\"id\"],\"populate_list\":[\"account_name_custno\",\"display_account_name\",\"selectedAccount\"],\"required_list\":[\"account_name_custno\"],\"conditions\":[{\"name\":\"custno_c\",\"op\":\"like_custom\",\"end\":\"%\",\"value\":\"\"}],\"order\":\"custno_c\",\"limit\":\"30\",\"no_match_text\":\"No Match\"};</script>".
            "<div id='newaccountdivlink' style='display:inline'><b>{$mod_strings['LNK_SELECT_ACCOUNT']}</b>&nbsp;"
    ."<input type=\"text\" tabindex=\"0\" autocomplete=\"off\" value=\"\" size=\"6\" class=\"sqsEnabled  \" id=\"account_name_custno\" name=\"acount_name_custno\" style=\"\"><input class='sqsEnabled' name='display_account_name' id='display_account_name' type=\"text\" value=\"\"><input name='selectedAccount' id='selectedAccount' type=\"hidden\" value=''>&nbsp;<input type='button' title=\"{$app_strings['LBL_SELECT_BUTTON_TITLE']}\" accessKey=\"{$app_strings['LBL_SELECT_BUTTON_KEY']}\" type=\"button\"  class=\"button\" value='{$app_strings['LBL_SELECT_BUTTON_LABEL']}' name=btn1 onclick='open_popup(\"Accounts\", 600, 400, \"\", true, false, $encoded_popup_request_data);'> <input type='button' title=\"{$app_strings['LBL_CLEAR_BUTTON_TITLE']}\" accessKey=\"{$app_strings['LBL_CLEAR_BUTTON_KEY']}\" type=\"button\"  class=\"button\" value='{$app_strings['LBL_CLEAR_BUTTON_LABEL']}' name=btn1 LANGUAGE=javascript onclick='document.forms[\"ConvertLead\"].selectedAccount.value=\"\";document.forms[\"ConvertLead\"].display_account_name.value=\"\"; '><br><b>{$app_strings['LBL_OR']}</b></div>";
