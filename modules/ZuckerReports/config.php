...
$zuckerreports_config = array(
	...
	"providers" => array(
            ...
            array(
                ...
                "class_name" => "QueryTemplate_FMP_Activity",
                "include" => "modules/ZuckerQueryTemplate/fmp.QueryTemplate.activity.php",
                "lang_key_new" => "LBL_QUERY_TEMPLATE_NEW",
                "menu_ext" => "no",
            ),
            array(
                "module" => "ZuckerQueryTemplate",
                "class_name" => "QueryTemplate_FMP_Opportunity",
                "include" => "modules/ZuckerQueryTemplate/fmp.QueryTemplate.opportunity.php",
                "lang_key_new" => "LBL_QUERY_TEMPLATE_NEW",
                "menu_ext" => "no",
            ),
			array(
