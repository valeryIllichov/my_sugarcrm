...
class TemplateHandler {
    ...
    function buildTemplate($module, $view, $tpl, $ajaxSave, $metaDataDefs) {
        ...
        $cacheDir = create_cache_directory($this->templateDir. $module . '/' . $groupLayout);
        $file = $cacheDir . $view . '.tpl';
        /* END - SECURITY GROUPS */ 
        ...
        if($view == 'EditView' || $view == 'QuickCreate' || $ajaxSave) {
            ...
            $contents .= $this->createQuickSearchCode($defs, $defs2);
            $contents .= "{/literal}\n";
    ...
    function checkTemplate($module, $view, $checkFormName = false, $formName='') {
        ...
        return file_exists($this->cacheDir . $this->templateDir . $module . '/' . $groupLayout .$view . '.tpl');
        /* END - SECURITY GROUPS */ 
    }
    ...
    function displayTemplate($module, $view, $tpl, $ajaxSave = false, $metaDataDefs = null) {
        ...
        $file = $this->cacheDir . $this->templateDir . $module . '/' . $groupLayout . $view . '.tpl';
