...
// selection settings for sales stages filter
function get_select_options_with_id_separate_key_sales_stage ($label_list, $key_list, $selected_key) {
	global $app_strings;
	$select_options = "";
...
//print_r($key_list);
//echo '<br>';
//print_r($selected_key);
//        print_r(']</pre>');
//        }
	foreach ($key_list as $option_key=>$option_value) {
        if (is_int($option_key)) $option_key = '0';
...
//$rr1 = ($option_key != '' && $selected_key == $option_key);
//$rr2 = ($selected_key == '' && $option_key == '');
//$rr3 = (is_array($selected_key) &&  in_array($option_key, $selected_key, true));
//echo $option_key . ' = ' . ((int) $rr1) . ', ' . ((int) $rr2) . ', ' . ((int) $rr3) . ', ';
//echo '<br/>';
//print_r(is_int($option_key));
//echo '<br/>';
//        print_r(']</pre>');
//        }
