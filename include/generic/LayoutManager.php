...
class LayoutManager
{
	...
	function getClassFromWidgetDef($widget_def, $use_default = false, $variable_for_opportunities = false)
	{
		...
		if($use_default) {
			switch($widget_def['name']) {
				case 'assigned_user_id':
                                    if($variable_for_opportunities == 'sales_reps'){
                                        $widget_def['widget_class'] = 'FieldSalesReps';
                                        /*This CUSTOM condition is to display Sales Reps List*/
                                    }else{
...
//					break;
	...
	function getFieldDef($widget_def){
		if(!empty($widget_def['module']) &&!empty($GLOBALS['beanList'][$widget_def['module']]) && !empty($GLOBALS['beanFiles'][$GLOBALS['beanList'][$widget_def['module']]])){
			include_once($GLOBALS['beanFiles'][$GLOBALS['beanList'][$widget_def['module']]]);
			$bean = new $GLOBALS['beanList'][$widget_def['module']]();
...
//				_pp($theclass);
	...
	function widgetDisplayInput($widget_def, $use_default = false, $variable_for_opportunities = false)
	{
		$theclass = $this->getClassFromWidgetDef($widget_def, $use_default, $variable_for_opportunities);
