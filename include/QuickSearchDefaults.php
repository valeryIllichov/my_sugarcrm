...
class QuickSearchDefaults {
    ...
    function getQSParent($parent = 'Accounts') {
        ...
        $qsParent = array(
                    ...
                    'group' => 'or',
                    'field_list' => array('name', 'custno_c', 'id', 'shipping_address_street', 'shipping_address_city', 'shipping_address_state','shipping_address_postalcode', ),
                    'populate_list' => array('parent_name','parent_name_custno', 'parent_id'),
    ...
    function getQSAccount($nameKey, $idKey, $billingKey = null, $shippingKey = null, $additionalFields = null) {
        ...
        $field_list = array('name', 'id', 'custno_c');
        $populate_list = array($nameKey, $idKey, 'account_name_custno');
        if($billingKey != null) {
    ...
    function getQSUser($p_name = 'assigned_user_name', $p_id ='assigned_user_id') {
        ...
        $qsUser = array(  'method' => 'get_user_array', // special method
                        'field_list' => array('user_name', 'id', 'custno_c', 'shipping_address_street', 'shipping_address_city', 'shipping_address_state','shipping_address_postalcode'),
