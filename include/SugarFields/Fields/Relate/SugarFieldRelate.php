...
//print_r($tabindex);
        ...
        $o['field_list'][] = 'shipping_address_street';
        $o['field_list'][] = 'shipping_address_city';
        $o['field_list'][] = 'shipping_address_state';
        $o['field_list'][] = 'shipping_address_postalcode';
        //, 'shipping_address_street', 'shipping_address_city', 'shipping_address_state','shipping_address_postalcode'
        $o['populate_list'] = array('account_name', 'account_name_custno', 'account_id');
        $o['required_list'] = array('account_id');
...
//           $thisev->th->ss->assign('quicksearch_js', $quicksearch_js);
      ...
      return $quicksearch_js.$this->fetch('include/SugarFields/Fields/Relate/EditView.tpl'); 
    }
