 ...
 ********************************************************************************/
*}
{{if $vardef.name == 'account_name'}}
<input type="text" name="{{sugarvar key='name'}}_custno" id="{{sugarvar key='name'}}_custno" tabindex='1' class="sqsEnabled" size="6" value="{fmp_activitycustno_value parent_type='Accounts' parent_id=$fields.account_id.value}" autocomplete="off">
{{/if}}
